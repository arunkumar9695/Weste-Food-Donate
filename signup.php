...
<body style="backgroun-color: #06C167;" >

    <div class="container">
    <div class="regform">
       
        <form action=" " method="post">
            <p class="logo">End <b style="color: #06C167;">Hunger</b></p>
            ...
            <div class="input">
             ...
             <div class="btn" >
                <button type="submit" name="sign" style="background-color:green">Register</button>
             </div>
